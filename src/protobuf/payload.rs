...
pub struct Payload {
    ...
    merchant_key: ::protobuf::SingularField<::std::string::String>,
...
impl Payload {
    ...
    // required string merchant_key = 4;


    pub fn get_merchant_key(&self) -> &str {
        match self.merchant_key.as_ref() {
            Some(v) => &v,
            None => "",
        }
    }
    pub fn clear_merchant_key(&mut self) {
        self.merchant_key.clear();
    }

    pub fn has_merchant_key(&self) -> bool {
        self.merchant_key.is_some()
    }

    // Param is passed by value, moved
    pub fn set_merchant_key(&mut self, v: ::std::string::String) {
        self.merchant_key = ::protobuf::SingularField::some(v);
    }

    // Mutable pointer to the field.
    // If field is not initialized, it is initialized with default value first.
    pub fn mut_merchant_key(&mut self) -> &mut ::std::string::String {
        if self.merchant_key.is_none() {
            self.merchant_key.set_default();
        }
        self.merchant_key.as_mut().unwrap()
    }

    // Take field
    pub fn take_merchant_key(&mut self) -> ::std::string::String {
        self.merchant_key.take().unwrap_or_else(|| ::std::string::String::new())
    }
...
impl ::protobuf::Message for Payload {
    ...
    fn merge_from(&mut self, is: &mut ::protobuf::CodedInputStream<'_>) -> ::protobuf::ProtobufResult<()> {
        while !is.eof()? {
            ...
            match field_number {
                ...
                4 => {
                    ::protobuf::rt::read_singular_string_into(wire_type, is, &mut self.merchant_key)?;
                },
                5 => {
                    if wire_type != ::protobuf::wire_format::WireTypeVarint {
                        return ::std::result::Result::Err(::protobuf::rt::unexpected_wire_type(wire_type));
    ...
    fn compute_size(&self) -> u32 {
        ...
        if let Some(ref v) = self.merchant_key.as_ref() {
    ...
    fn descriptor_static() -> &'static ::protobuf::reflect::MessageDescriptor {
        ...
        descriptor.get(|| {
            ...
            fields.push(::protobuf::reflect::accessor::make_singular_field_accessor::<_, ::protobuf::types::ProtobufTypeString>(
                "merchant_key",
                |m: &Payload| { &m.merchant_key },
                |m: &mut Payload| { &mut m.merchant_key },
            ));
